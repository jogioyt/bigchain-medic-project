...
def main():
    ...
    print("Admin Transaction Detail: ")
    print(adminGroup)
    print("=============================")
    ...
    tribe2 = createType(creator_keys, namespace, 'tribe2', appId, adminGroupId)
    ...
    user2_input = createUser(namespace, creator_keys, tribe1Id, 'tribe2', user2_keys["public_key"])
    ...
    user3_input = createUser(namespace, creator_keys, tribe1Id, 'tribe2', user3_keys["public_key"])
    ...
    """
    tribe1_proposal = createType(creator_keys, namespace, 'proposal', appId, tribe1Id)
    tribe2_vote = createType(creator_keys, namespace, 'vote', appId, tribe2Id)
